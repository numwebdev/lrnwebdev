                ...
                <div align="center">
                    ...
                    <section id="banner">
                        ...
                        <span class="image object">
                            <img className="shadow" src="../../images/html.gif" alt="lrnwebdev_html" />
                        </span>
                    </section>
                    <br />
                    <section>
                                    ...
                                    <article>
                                        <div className="container">
                                            <div class="card bg-transparent shadow rounded-1" align="left">
                                                <img class="card-img-top" src="../../images/css.gif" alt="lrnwebdev" />
                                                <div class="card-body">
                                    ...
                                    <article>
                                        <div className="container mt-3 mt-lg-0">
                                            <div class="card bg-transparent shadow" align="left">
                                                <img class="card-img-top" src="../../images/js.gif" alt="lrnwebdev" />
                                                <div class="card-body">
